...
class CategoryEdit extends Component
{
    ...
    public $categories = []; // Add this line to hold categories
    ...
    //     $this->parentCategoryId = $category->parent_id; // Get the current parent_id
    ...
    public function mount($categoryId)
    {
        ...
        // Load all categories excluding the current category itself
        $this->categories = Category::where('id', '!=', $categoryId)
            ->with('children', 'translations')->get();
