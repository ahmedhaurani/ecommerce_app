...
class EditBrand extends Component
{
    ...
    public function save()
    {
        ...
        $brand = Brand::find($this->brand_id); // Assuming you are editing an existing brand

        // Check if a new logo is uploaded
        if ($this->logo && is_object($this->logo)) {
            $logoPath = $this->logo->store('logos', 'public'); // Store the new logo
            $brand->logo = $logoPath; // Update the logo path
        }
