...
class EditProduct extends Component
{
    ...
    protected $rules = [
        ...
        'product.sale_price' => 'nullable|numeric|lt:product.price', // Sale price should be less than price
    ...
    public function editLocale($productId, $locale) {
    ...
    public function mount($productId, $locale = 'en')
    {
        $this->productId = $productId;
