                ...
                <div class="w-full px-3 lg:w-3/4">
                    ...
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-3">
                        @foreach ($products as $product)
                            <div class="bg-white border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                                ...
                                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                    <a wire:click.prevent="addToCart({{$product->id}})" href="#" class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                                        ...
                                        <span wire:loading wire:target="addToCart({{ $product->id }}, {{ $variation_id ?? 'null' }})">Adding..</span>
                                    </a>
                                </div>
                            </div>
                        @endforeach
