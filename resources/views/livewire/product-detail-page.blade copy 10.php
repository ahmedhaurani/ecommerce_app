            ...
            <div class="flex flex-wrap -mx-4" :class="{'flex-row-reverse': document.documentElement.dir === 'rtl'}">
                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="carousel({{ json_encode($images) }})">
                    ...
                    <div
                        ...
                        <img :src="currentImage" alt=" {{$translation->name}}"
...
<div>
    ...
    @endif
            ...
            <div class="mt-8">
                <h2 class="text-lg font-semibold mb-4">{{ __('product.share_this_product') }}</h2>
                <div class="flex gap-4">
                    <!-- WhatsApp -->
                    <a href="https://api.whatsapp.com/send?text={{ urlencode(url()->current()) }}"
                       target="_blank"
                       class="flex items-center justify-center w-10 h-10 text-white bg-green-500 rounded-full hover:bg-green-600 transition shadow-md hover:shadow-lg transition-transform transform hover:scale-110">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}"
                       target="_blank"
                       class="flex items-center justify-center w-10 h-10 text-white bg-blue-600 rounded-full hover:bg-blue-600 transition shadow-md hover:shadow-lg transition-transform transform hover:scale-110">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <!-- Instagram (custom implementation) -->
                    <a href="https://www.instagram.com/?url={{ urlencode(url()->current()) }}"
                       target="_blank"

                       class="flex items-center justify-center w-10 h-10 text-white bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 rounded-full shadow-md hover:shadow-lg transition-transform transform hover:scale-110">
...
<script>
    ...
    return {
        ...
        isModalOpen: false,
        modalImage: '',
        zoomStyles: {}, // Style for zoom effect
        get currentImage() {
        ...
        openModal(image) {
            ...
            this.resetZoom(); // Ensure no zoom styles are applied initially
        },
        closeModal() {
            this.isModalOpen = false;
            this.modalImage = '';
            this.resetZoom(); // Reset zoom styles when modal closes
        },
        zoomImage(event) {
