                        ...
                        <div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                    <input type="number" wire:model.live="priceRange.0" class="w-20 p-2 border border-gray-300 rounded-lg" placeholder="Min" min="0">
                                    <span class="text-gray-700 dark:text-gray-300">-</span>
                                    <input type="number" wire:model.live="priceRange.1" class="w-20 p-2 border border-gray-300 rounded-lg" placeholder="Max" min="0">
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <select wire:model="sortBy" class="w-full p-2 border border-gray-300 rounded-lg">
                            ...
                            <div class="flex justify-end">
                                <button wire:click="resetFilters" class="px-4 py-2 bg-red-600 text-white rounded-lg">Reset Filters</button>
                            </div>
                        </div>
                    </div>
                </div>
