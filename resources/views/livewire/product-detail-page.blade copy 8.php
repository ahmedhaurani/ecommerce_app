                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="mb-8">
                            ...
                            <span
                                ...
                                {{ $discountPercentage }}% {{ __('product.off') }}
                            </span>
                            @endif
                            <!-- Rating Stars -->
                            ...
                            <!-- Price -->
                            <!-- Price Section -->
                            <div class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400">
                                @if($product->sale_price < $product->price)
                                    <span class="text-red-600">{{ __('currency_symbol') }}{{
                                        number_format($product->sale_price, 2) }}</span>
                                    <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">
                                        {{ __('currency_symbol') }}{{ number_format($product->price, 2) }}
                                    </span>
                                    @else
                                    <span>{{ __('currency_symbol') }}{{ number_format($product->price, 2) }}</span>
                                    @endif
                            </div>
