<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme sidebar sidebar-offcanvas">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Products -->
        <li class="menu-item {{ request()->is('e/admin/products*') ? 'active open' : '' }}">
        ...
        <!-- Categories -->
        <li class="menu-item {{ request()->is('e/admin/categories*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Categories">Categories</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('category.management') ? 'active' : '' }}">
                    <a href="{{ route('category.management') }}" class="menu-link">
        ...
        <!-- Brands -->
        <li class="menu-item {{ request()->is('e/admin/brands*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-label"></i>
                <div data-i18n="Brands">Brands</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('admin.brands.list') ? 'active' : '' }}">
                    <a href="{{ route('admin.brands.list') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->routeIs('admin.settings') ? 'active open' : '' }}">
            <a href="{{ route('admin.settings') }}" class="menu-link">
                ...
                <div data-i18n="Settings">Website Settings</div>
            </a>
        </li>
    </ul>
