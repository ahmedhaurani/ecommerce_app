...
<i class="fas fa-search text-base"></i> <!-- Replace text with icon -->
    ...
    <div class="flex items-center space-x-4  rtl:space-x-reverse">
        ...
        <a href="{{ route('cart', ['locale' => app()->getLocale()]) }}"
           class="relative flex items-center px-4 py-1 text-sm font-medium text-white bg-blue-600 border border-blue-700 rounded-md shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all md:px-6">
            <span class="hidden md:inline text-xs font-semibold"> {{ __('general.cart') }} </span>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 md:mr-2" viewBox="0 0 1792 1792" fill="currentColor">
                <path d="M704 1536q0 52-38 90t-90 38-90-38-38-90 38-90 90-38 90 38 38 90zm896 0q0 52-38 90t-90 38-90-38-38-90 38-90 90-38 90 38 38 90zm128-1088v512q0 24-16.5 42.5t-40.5 21.5l-1044 122q13 60 13 70 0 16-24 64h920q26 0 45 19t19 45-19 45-45 19h-1024q-26 0-45-19t-19-45q0-11 8-31.5t16-36 21.5-40 15.5-29.5l-177-823h-204q-26 0-45-19t-19-45 19-45 45-19h256q16 0 28.5 6.5t19.5 15.5 13 24.5 8 26 5.5 29.5 4.5 26h1201q26 0 45 19t19 45z"/>
            </svg>
            <span
            class="text-xs font-medium bg-red-500 text-white text-xs font-bold rounded-full px-1.5 ">
            {{$total_count}}
        </span>
            <span class="absolute top-0 right-0 transform translate-x-1 -translate-y-1 bg-red-500 text-white text-xs font-bold rounded-full px-1.5">
                {{ $total_count }}
            </span>
        </a>
        ...
        @if(Auth::check())
            <div x-data="{ open: false }" class="relative">
                ...
                <button @click="open = !open" class="flex items-center px-4 py-1 text-sm font-medium text-white bg-blue-600 border border-blue-700 rounded-md shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all md:px-6">
                    <span class="hidden md:inline font-semibold">{{ __('general.account') }}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 md:ml-2" viewBox="0 0 1792 1792" fill="currentColor">
                        <path d="M1600 1405q0 120-73 189.5t-194 69.5h-874q-121 0-194-69.5t-73-189.5q0-53 3.5-103.5t14-109 26.5-108.5 43-97.5 62-81 85.5-53.5 111.5-20q9 0 42 21.5t74.5 48 108 48 133.5 21.5 133.5-21.5 108-48 74.5-48 42-21.5q61 0 111.5 20t85.5 53.5 62 81 43 97.5 26.5 108.5 14 109 3.5 103.5zm-320-893q0 159-112.5 271.5t-271.5 112.5-271.5-112.5-112.5-271.5 112.5-271.5 271.5-112.5 271.5 112.5 112.5 271.5z"/>
                    </svg>
                </button>

                <!-- Dropdown Menu -->
                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg z-50">
        ...
        @else
            ...
            <a href="{{ route('login', ['locale' => app()->getLocale()]) }}"
               class="flex items-center px-4 py-1 text-sm font-medium text-white bg-blue-600 border border-blue-700 rounded-md shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all md:px-6">
                <span class="hidden md:inline  text-xs  font-semibold">{{ __('general.login') }}</span>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 md:mr-2 md:ml-2" viewBox="0 0 1792 1792" fill="currentColor">
                    <path d="M1600 1405q0 120-73 189.5t-194 69.5h-874q-121 0-194-69.5t-73-189.5q0-53 3.5-103.5t14-109 26.5-108.5 43-97.5 62-81 85.5-53.5 111.5-20q9 0 42 21.5t74.5 48 108 48 133.5 21.5 133.5-21.5 108-48 74.5-48 42-21.5q61 0 111.5 20t85.5 53.5 62 81 43 97.5 26.5 108.5 14 109 3.5 103.5zm-320-893q0 159-112.5 271.5t-271.5 112.5-271.5-112.5-112.5-271.5 112.5-271.5 271.5-112.5 271.5 112.5 112.5 271.5z"/>
                </svg>
            </a>
        @endif
