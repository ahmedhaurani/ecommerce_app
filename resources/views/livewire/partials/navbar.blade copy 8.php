...
<i class="fas fa-search text-base"></i> <!-- Replace text with icon -->
    ...
    <!-- Login Icon -->
    <a href="{{ route('login', ['locale' => app()->getLocale()]) }}" class="bg-blue-700 text-white p-3 rounded-full hover:bg-blue-800 flex items-center justify-center transition duration-200 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div
                ...
                <div class="language-switcher">
                    <!-- Switch to Arabic -->
                    <a href="{{ locale_route(Route::currentRouteName(), array_merge(request()->route()->parameters(), ['locale' => 'ar'])) }}">
                        Arabic
                    </a>

                    <!-- Switch to English -->
                    <a href="{{ locale_route(Route::currentRouteName(), array_merge(request()->route()->parameters(), ['locale' => 'en'])) }}">
                        English
                    </a>
                </div>
