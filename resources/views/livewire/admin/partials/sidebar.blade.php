<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme sidebar sidebar-offcanvas">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            <span class="app-brand-logo demo">
                <svg viewBox="0 0 1188 1280" width="1188" height="1280">
                    <defs>
                      <linearGradient gradientUnits="userSpaceOnUse" x1="5941.865" y1="11.863" x2="5941.865" y2="12800" id="gradient-0" gradientTransform="matrix(0.303667, -0.952778, 0.476686, 0.151928, 2741.81385, 13055.955516)">
                        <stop offset="0" style="stop-color: rgba(255, 148, 8, 1)"></stop>
                        <stop offset="1" style="stop-color: rgba(161, 91, 0, 1)"></stop>
                      </linearGradient>
                    </defs>
                  ...
                  -1 7 -3z" style="paint-order: fill; fill: url(#gradient-0);"></path>
                    </g>
                  </svg>

            </span>
            <span class="app-brand-text demo menu-text fw-bold ms-2">{{ $appSetting->website_name ?? '' }}</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item  {{ (request()->is('admin/posts*')) ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle " data-bs-toggle="collapse" href="#لاخخنس">
                ...
                <div data-i18n="Cards">Pagesss</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ (request()->is('*posts')) ? 'active' : '' }}">
                    <a href="{{url('admin/posts')}}" class="menu-link">
                        <div data-i18n="Basic">جميع المقالات</div>
                    </a>
                </li>
                <li class="menu-item {{ (request()->is('*posts/create')) ? 'active' : '' }}">
                    <a href="{{url('admin/posts/create')}}" class="menu-link ">
                        <div data-i18n="Advance">إضافة مقال</div>
                    </a>
                </li>
            </ul>
...
{{--
        <li class="menu-item  {{ (request()->is('admin/cvs*')) ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle " data-bs-toggle="collapse" href="#category">
                <i class="menu-icon tf-icons bx bx-share-alt active"></i>
                <div data-i18n="Cards">رسائل</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ (request()->is('*cvs')) ? 'active' : '' }}">
                    <a href="/admin/cvs" class="menu-link">
                        <div data-i18n="Basic">الرسائل</div>
                    </a>
                </li>
                <li class="menu-item {{ (request()->is('*cvs/create')) ? 'active' : '' }}">
                    <a href="{{url('admin/cvs/create')}}" class="menu-link ">
                        <div data-i18n="Advance">إضافة سيرة ذاتية </div>
                    </a>
                </li>
            </ul>
        </li> --}}

        <li class="menu-item  {{ (request()->is('*queries')) ? 'active' : '' }}">
            <a href="{{url('admin/queries')}}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-home-circle"></i>
              <div data-i18n="Page 1">الرسائل</div>
            </a>
          </li>
        ...
        <li class="menu-item  {{ (request()->is('*settings')) ? 'active' : '' }}">
            <a href="{{url('admin/settings')}}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-home-circle"></i>
              <div data-i18n="Page 1">معلومات الموقع</div>
            </a>
          </li>
