                ...
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" id="sale_price" class="form-control" wire:model="product.sale_price" step="0.01">
                            @error('product.sale_price') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" id="featured" class="form-check-input" wire:model="product.featured">
                            <label class="form-check-label" for="featured">Featured</label>
                            @error('product.featured') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content mt-3" id="myTabContent">
                        ...
                        <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="{{ $locale }}"
                            ...
                            <div class="form-group mb-3">
                                <label for="description_{{ $locale }}">Description</label>
                                <div id="quill-editor-{{ $locale }}" class="quill-editor"></div>
                                @error('translations.' . $locale . '.description')
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mb-2 position-relative d-flex flex-column align-items-center">
                            <div class="image-container">
                                ...
                                <div class="button-overlay d-flex justify-content-between w-100">
                                    <!-- Up Button -->
                            ...
                            <!-- Remove Button -->
                            <button type="button" class="btn btn-danger btn-icon mt-2" wire:click="removeImage({{ $index }})">
