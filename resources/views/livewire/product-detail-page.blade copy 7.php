<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto rounded-lg" :dir="document.documentElement.dir">
    ...
    @endif
                        ...
                        <div class="w-32 mb-8">
                            <label for="quantity"
                                class="w-full pb-1 text-lg font-semibold text-gray-700 border-b border-blue-300 dark:border-gray-600 dark:text-gray-400">{{ __('product.quantity') }}</label>
                          ...
                          <div>
                            ...
                            <div class="flex flex-wrap gap-4 mb-6">
                                ...
                                <button wire:click="$set('selectedVariation', {{ $variation->id }})"
                                    class="px-4 py-2 border rounded-md transition duration-200 bg-blue-500-outline
...
{!! $translation->description !!}
            ...
            <div class="mt-10 grid grid-cols-1 md:grid-cols-1 gap-8">
                ...
                <div class="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
                    <h3 class="text-3xl font-semibold text-gray-800 dark:text-gray-300">{{ __('product.rating_summary') }}</h3>
...
<button wire:click.prevent="submitReview"
    ...
    {{ __('product.submit_review') }}ddddddddddddddd
</button>
...
@endif
            ...
            <!-- Reviews Section -->
            <div class="mt-10">
                <h3 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">{{ __('product.customer_reviews') }}</h3>
                @php
                ...
                @else
                    ...
                    <div class="p-4 my-4 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-md transition-colors duration-500">
                        <p class="text-lg font-semibold text-gray-800 dark:text-gray-200">
                            ...
                            <p class="mt-2 text-gray-700 dark:text-gray-300">{{ $review->review }}</p>                        </div>
                    @endforeach
                @endif
            </div>
