            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="carousel({{ json_encode($images) }})">
                    <div class="relative">
                        ...
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4">
                            <img :src="currentImage" alt="Main Product Image" class="object-cover w-full h-64 lg:h-full rounded-md shadow-lg">
                        </div>
                    ...
                    <div class="flex mt-4 space-x-2">
                        <template x-for="(image, index) in images" :key="index">
                            <div class="w-20 h-20 overflow-hidden rounded-md cursor-pointer hover:opacity-75" @click="setCurrentImage(image)">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                @if($product->variations->isNotEmpty())
                                    ...
                                    <select wire:model="selectedVariation">
                                        ...
                                        @foreach($product->variations as $variation)
                                            @php
                                                // Safely get the translation for the current locale
                                ...
                                {{-- <div>
                                    ...
                                    <input type="number" id="quantity" wire:model="quantity" min="1" value="{{ $quantity }}">
                                </div> --}}
                        ...
                        <button wire:click="addToCart({{ $product->id }}, {{ $variation_id ?? 'null' }})">Add to Cart</button>
