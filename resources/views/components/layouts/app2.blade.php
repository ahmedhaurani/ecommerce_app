...
<!-- Open Graph Tags for Social Sharing -->
<meta property="og:title" content="{{ $title ?? '22' }}">
<meta property="og:description" content="{{ $metaDescription ?? 'Default description of the page' }}">
<meta property="og:image" content="{{ $mainImage ?? asset('default-image.jpg') }}">
<meta property="og:type" content="{{ $ogType ?? 'website' }}"> <!-- Default to 'website' -->
<meta property="og:url" content="{{ url()->current() }}">
...
<meta name="twitter:title" content="{{ $title ?? '22' }}">
<meta name="twitter:description" content="{{ $metaDescription ?? 'Default description of the page' }}">
<meta name="twitter:image" content="{{ $mainImage ?? asset('default-image.jpg') }}">

<!-- Structured Data (JSON-LD) for Rich Snippets, only for Product Pages -->
